...
## Overview
---
- This is my second Milestone 2 project which is part of the Code Institute’s Full Stack Software Development Diploma Course.
...
- Wroclaw the city of dwarfs is an interactive guide of a Polish city located in the south-west of Poland. 
...
as well as the accommodation and gastronomy facilities offered by the city. This website was created to encourage everyone to visit this 
...
This website design will target tourists of all ages, families with children and friends who are looking for the next city break destination,
 as those intended to visit Poland. The main purpose of this project was to create and interactive guide website with easy and quick access to
 information about the city by presenting main attractions, accommodation and gastronomy facilities, displayed on the map, where visitors can search 
...
My goal for this project is to promote the Wroclaw as the next city break destination and increase the interest of tourist activity.
 It is intended to be used as an interactive guide to help navigate through the attractions, restaurants, pubs, accommodation through 
...
- Provide a useful information about the city and demonstrate various activities, accommodation, and places to eat 
...
The navigation bar was initially set to be transparent. While scrolling down it supposed to turn black however, during the development
...
Initially, in the about section, there supposed to be a currency showing images with Polish coins,
...
and due to its popularity this is a font that many users will be familiar with. It evokes a feeling of trust 
...
- [Latlong.net](https://www.latlong.net/) to find the latitude and longitude for Poland, Wroclaw and some markers for the map
...
1.  [Google Maps JavaScript API](https://developers.google.com/maps/documentation/places/web-service/overview) used to create the map
    - Initially, the map displays the locations of Poland and a marker that shows the locations of Wroclaw city
       when hovering over it the name of Wroclaw appears.
    - Next to the map there are buttons which contain places associated to Attractions, Food&Drinks, Accommodation and Dwarf Hunting. 
...
- [Tripadvisor](https://www.tripadvisor.ie/) - resource for Accommodation and FOOD and Drinks in Attractions section.
...
- [Wikipedia](https://en.wikipedia.org) - resource for information about the attractions in Wroclaw .
- [Wikipedia/dwarfs](https://pl.wikipedia.org/wiki/Wroc%C5%82awskie_krasnale) - resource about dwarfs localization.
- [Visit Wroclaw](https://visitwroclaw.eu/en) - polish website for the attraction section content.
...
- [youtube](https://www.youtube.com/) - used for general resource.
...
1. Go to the [EmailJS](https://www.emailjs.com/) website and choose documentation tab at the top.
...
- [Wikipedia](https://en.wikipedia.org/wiki/Wroc%C5%82aw%27s_dwarfs) - description of the dwarfs and their location latitude and longitude.
...
- [Jonah Lawrence](https://www.youtube.com/watch?v=WZNG8UomjSI&t=1s&ab_channel=JonahLawrence%E2%80%A2DevProTips) - tutorial how to build a Weather APP.
